...
* information)
*/
public class SubscriptionOperationsExtensions
{
    /**
    ...
    */
    public static SubscriptionGetResponse Get(ISubscriptionOperations operations)
    {
        return operations.GetAsync().getResult();
    }
    ...
    */
    public static SubscriptionListOperationsResponse ListOperations(ISubscriptionOperations operations, SubscriptionListOperationsParameters parameters)
    {
        return operations.ListOperationsAsync(parameters).getResult();
    }
    ...
    * request ID.
    */
    public static OperationResponse RegisterResource(ISubscriptionOperations operations, String resourceName)
    {
        return operations.RegisterResourceAsync(resourceName).getResult();
    }
    ...
    * request ID.
    */
    public static OperationResponse UnregisterResource(ISubscriptionOperations operations, String resourceName)
    {
        return operations.UnregisterResourceAsync(resourceName).getResult();
    }
}
