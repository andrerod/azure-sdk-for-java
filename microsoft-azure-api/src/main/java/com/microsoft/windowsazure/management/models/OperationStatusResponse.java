...
public class OperationStatusResponse extends OperationResponse
{
    ...
    */
    public HttpStatus getHttpStatusCode() { return this._httpStatusCode; }
    
    /**
    * The HTTP status code for the asynchronous request.
    */
    public void setHttpStatusCode(HttpStatus httpStatusCode) { this._httpStatusCode = httpStatusCode; }
