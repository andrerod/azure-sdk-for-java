...
public interface IAffinityGroupOperations
{
    ...
    * request ID.
    */
    OperationResponse create(AffinityGroupCreateParameters parameters) throws InterruptedException, ExecutionException, ParserConfigurationException, SAXException, TransformerConfigurationException, TransformerException, UnsupportedEncodingException, CloudException, IOException;
    ...
    * request ID.
    */
    OperationResponse createAsync(AffinityGroupCreateParameters parameters) throws ParserConfigurationException, SAXException, TransformerConfigurationException, TransformerException, UnsupportedEncodingException, InterruptedException, ExecutionException, CloudException, IOException;
    ...
    * request ID.
    */
    OperationResponse deleteAsync(String affinityGroupName) throws InterruptedException, ExecutionException, CloudException, IOException;
    ...
    * @return The Get Affinity Group operation response.
    */
    AffinityGroupGetResponse getAsync(String affinityGroupName) throws InterruptedException, ExecutionException, CloudException, ParserConfigurationException, SAXException, IOException, URISyntaxException, ParseException;
    ...
    * @return The List Affinity Groups operation response.
    */
    AffinityGroupListResponse listAsync() throws InterruptedException, ExecutionException, CloudException, ParserConfigurationException, SAXException, IOException, ParseException;
    ...
    * request ID.
    */
    OperationResponse update(String affinityGroupName, AffinityGroupUpdateParameters parameters) throws InterruptedException, ExecutionException, ParserConfigurationException, SAXException, TransformerConfigurationException, TransformerException, UnsupportedEncodingException, CloudException, IOException;
    ...
    * request ID.
    */
    OperationResponse updateAsync(String affinityGroupName, AffinityGroupUpdateParameters parameters) throws ParserConfigurationException, SAXException, TransformerConfigurationException, TransformerException, UnsupportedEncodingException, InterruptedException, ExecutionException, CloudException, IOException;
}
