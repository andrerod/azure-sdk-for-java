...
public interface IManagementCertificateOperations
{
    ...
    * request ID.
    */
    OperationResponse CreateAsync(ManagementCertificateCreateParameters parameters);
    ...
    * request ID.
    */
    OperationResponse DeleteAsync(String thumbprint);
    ...
    */
    ManagementCertificateGetResponse GetAsync(String thumbprint);
    ...
    */
    ManagementCertificateListResponse ListAsync();
}
